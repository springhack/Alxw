...
var jsWidgetPath = document.scripts;
jsWidgetPath = jsWidgetPath[jsWidgetPath.length-1].src.substring(0, jsWidgetPath[jsWidgetPath.length-1].src.lastIndexOf("/")+1);
var uploadFilePath = "!" + jsWidgetPath.replace("/xhEditor", "/fileUpload") + "index.php";
